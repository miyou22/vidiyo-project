  ...
  <a href="#" class="imageLink">
    <div class="movieTitle">
      ...
      <div class="movieText">
        <div class="bgi"></div>
        <p>"나는요...완전히 붕괴되었어요"</p>                                                                         
        <p>당신의 고백을 들은 순간, 내 사랑이 시작되었어요</p>
      </div>
    </div>
  </a>
      ...
      items: [
        {
          ...
          h2 : '새로 올라온 컨텐츠',
          p : '라방, 본아페티, 그놈들 등',
          img : require('../assets/image/figure1.png'),
        },
        {
          span : '추천영화',
          h2 : '트와일라잇 시리즈',
          p : '얼음보다 차갑고 빛보다 빠른 그들이 온다!', 
          img : require('../assets/image/figure2.png'),
        },
        {
          span : '추천리스트',
          h2 : '죽기전에 봐야 할 명작',
